...
export const metadata: Metadata = {
  title: "Sustainable Living Community - Explore Our Eco-Friendly Home & Initiatives",
  description: "Discover our vibrant, sustainable living community dedicated to eco-friendly homes and renewable energy initiatives. Join us in making a positive impact on the environment.",
  keywords: ["sustainable living", "eco-friendly homes", "renewable energy", "green technology", "community events", "transportation solutions"]
};
